...
fn main() {
    ...
    println!("result : {:?}", str_aux.value);
    str_aux.append_number(5.0);
    println!("result : {:?}", str_aux.value);
...
mod tests {
    ...
    fn test_append_str() {
        ...
        assert_eq!(String::from("hello there!"), str_aux.append_str(String::from(" there!")).value);
    ...
    fn test_remove_punctuation() {
        ...
        assert_eq!(String::from("hello there"), str_aux.remove_punctuation_marks().value);
    }
